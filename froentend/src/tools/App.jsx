...
import '../css/App.css';
import MainSection from './ImpSec';
import Cart from './Cart';
import Foods from './Yummy';
...
function App() {
  ...
  return (
    <Router>
      <header>
      <nav>
          <NavLink className="logo" to="/"><h1>Yummy Food Ordering website</h1></NavLink>
      ...
      <Routes>
        ...
        <Route path='/food/:foodId' element={<Yummy items={items} setCartItems={setCartItems} />} />
      </Routes>
    </Router>
  );
}
